...
add_button = ctk.CTkButton(header_frame, text="+", width=40, height=40, corner_radius=40,
                           fg_color="steelblue",  font=("Helvetica", 18, "bold"),
...
def update_camera_feed():
    ...
    if results.multi_hand_landmarks:
        for hand_landmarks in results.multi_hand_landmarks:
            ...
            if (index_extended and not middle_extended and not ring_extended and not pinky_extended and not gesture_cooldown_active):
            ...
            # Define the gesture: Index and Middle extended, Ring and Pinky folded.
